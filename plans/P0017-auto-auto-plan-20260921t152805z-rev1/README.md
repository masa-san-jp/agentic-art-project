# auto-auto-plan-20260921t152805z-rev1
...
形式: SVG vector files containing three self-authored arrival, threshold, and return states (PROPOSED)（A 600 mm by 600 mm equivalent viewBox preserving the accepted frame ratio; raster resolution is not production truth. (PROPOSED)）。正本の本文と、受入済み attestation が列挙する asset を参照します。
